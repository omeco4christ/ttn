...
function getContentCSS() {
  ...
  return `
    <style>
        @font-face{
            font-family: Avenir;
            src: url('file:///android_asset/fonts/AvenirLTStd-Book.otf') format("opentype");
        }
        @font-face{
            font-family: Avenir;
            font-weight: bold;
            src: url('file:///android_asset/fonts/AvenirLTStd-Black.otf') format("opentype");
        }
        ...
        *{
        ...
        pre{padding: 10px 5px 10px 10px;margin: 15px 0;display: block;line-height: 18px;background: #F0F0F0;border-radius: 6px;font-size: 13px; word-break: break-all; word-wrap: break-word;overflow-x: auto;}
...
<head>
    ...
    <style>
        ...
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;box-sizing: border-box;}
        html, body { margin: 0; padding: 0;font-family: Avenir; font-size:1em; height: 100%}
        body { overflow-y: hidden; -webkit-overflow-scrolling: touch;background-color: ${backgroundColor};caret-color: ${caretColor};}
        .content {font-family: Avenir;color: ${color}; width: 100%;${
